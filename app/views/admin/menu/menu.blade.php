<div class="sidebar-menu toggle-others fixed" style="">
    ...
    <div class="sidebar-menu-inner ps-container ps-active-y">	
        ...
        <header class="logo-env">
            ...
            <div class="logo">
                <a href="dashboard-1.html" class="logo-expanded">
                    <img src="assets/backend/images/logo@2x.png" width="80" alt="">
                </a>

                <a href="dashboard-1.html" class="logo-collapsed">
                    <img src="assets/backend/images/logo-collapsed@2x.png" width="40" alt="">
                </a>
            </div>
        ...
        <div class="ps-scrollbar-x-rail" style="display: block; width: 340px; left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="display: inherit; top: 0px; height: 354px; right: 2px;"><div class="ps-scrollbar-y" style="top: 0px; height: 219px;"></div></div></div>
