...
$base_url =
	...
	'://'.
	// Get domain portion
	$_SERVER['HTTP_HOST'].'/filemanager/'; // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = app_path('/file/');// ;'/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = app_path('file/'); // relative path from filemanager folder to upload folder (with final /)
