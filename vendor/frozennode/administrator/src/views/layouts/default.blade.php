...
<head>
	...
	@endforeach
        ...
        <!--
        <link href="<?php echo asset('assets/frontend/bootstrap/css/bootstrap.min.css') ?>" media="all" type="text/css" rel="stylesheet">
        <link href="<?php echo asset('assets/frontend/bootstrap/css/bootstrap-glyphicons.css') ?>" media="all" type="text/css" rel="stylesheet">
	-->
	<!--[if lte IE 9]>
	...
	<![endif]-->
        ...
        <script>
        UPLOADCARE_PUBLIC_KEY = '79bfef74195ea76bf4af';
        </script>
</head>
<body>
	<div id="wrapper">
