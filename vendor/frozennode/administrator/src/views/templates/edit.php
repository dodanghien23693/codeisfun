...
<form class=" " data-bind="visible: !loadingItem(), submit: saveItem">
	...
	<!-- ko foreach: editFields -->
		<!-- ko if: $data && ( $root[$root.primaryKey]() || editable ) && visible -->
			<div data-bind="attr: {class: type}">
                            <label data-bind="attr: {for: field_id}, text: title + ':'" class="control-label"></label>
			...
			<!-- ko if: type === 'text' -->
				<!-- ko if: editable -->
					...
					<input class="form-control" type="text" data-bind="attr: {disabled: $root.freezeForm, id: field_id}, value: $root[field_name],
